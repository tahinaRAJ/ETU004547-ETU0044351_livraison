...
/* $app->set('flight.base_url', '/ETU004547/ETU004351-ETU004547_taxibe/my-project',);  */
...
return [
	...
	'database' => [
		...
		//'dbname'   => 'db_s2_ETU004547',   // Database name (e.g., 'flightphp')
		//'user'     => 'ETU004547',  // Database user (e.g., 'root')
		//'password' => 'hp9wriRv',  // Database password (never commit real passwords)
	...
	// 	'password' => ' ',
	// 	'charset'  => 'utf8',
	// 	'port'     => 5432 // Optional, default PostgreSQL port
	// ],
